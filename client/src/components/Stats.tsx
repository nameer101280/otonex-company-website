export function Stats() {
  ...
  return (
    <section id="stats" className="py-32 bg-black border-t border-purple-800/30 relative">
      {/* Background effect */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {stats.map((stat, i) => (
            <div 
              key={i} 
              className="text-center p-8 border border-purple-800/40 hover:border-purple-700/70 transition-all duration-300 group hover:bg-gradient-to-br hover:from-purple-900/20 hover:to-black rounded-lg animate-fade-in-up overflow-hidden relative"
            ...
            >
              ...
              <div className="text-5xl sm:text-6xl font-light bg-gradient-to-r from-purple-400 to-purple-500 bg-clip-text text-transparent mb-3 relative z-10">{stat.number}</div>
