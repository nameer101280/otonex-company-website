export function Values() {
  ...
  return (
    <section id="values" className="py-32 bg-black border-t border-purple-800/30 relative">
      {/* Background effect */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {values.map((value, i) => (
            <div 
              key={i} 
              className="p-8 border border-purple-800/40 hover:border-purple-700/70 transition-all duration-300 group hover:bg-gradient-to-br hover:from-purple-900/30 hover:to-black rounded-lg animate-fade-in-up overflow-hidden relative"
