    ...
    <section id="values" className="py-24 bg-black border-t border-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <p className="text-gray-500 animate-fade-in-up stagger-1">What drives Autonex</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {values.map((value, i) => (
            <div 
              key={i} 
              className={`p-8 border border-gray-800 hover:border-gray-700 transition-colors duration-300 animate-fade-in-up ${
                i === 0 ? '' : `stagger-${i + 1}`
              }`}
            >
